...
export default function DotedTemplate({ resumeData, selectedTheme }) {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white shadow-lg" style={{ direction }}>
      <div className="bg-slate-800 text-white relative">
        <div className="container mx-auto px-8 pt-8 pb-20 relative z-10">
          ...
          <div className="flex-1">
            ...
            <section className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                <h3 className="text-2xl font-semibold">{t.workExperience}</h3>
              </div>
